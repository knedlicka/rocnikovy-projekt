...
template<typename T>
std::set<std::multiset<T>> Combinatorics::combinations_with_repetitions(std::multiset<T> &s, int k) {
    int n = s.size();
...
template<typename T>
std::set<std::set<T>> Combinatorics::combinations_without_repetitions(std::set<T> &s, int k) {
...
template<typename T>
std::multiset<std::vector<T>> Combinatorics::permutations_with_repetitions(std::multiset<T> &s) {
    int n = s.size();
...
template<typename T>
std::set<std::vector<T>> Combinatorics::permutations_without_repetitions(std::set<T> &s) {
    std::multiset<T> ms(s.begin(), s.end());
...
template<typename T>
std::multiset<std::vector<T>> Combinatorics::arrangements_with_repetitions(std::multiset<T> &s, int k){
...
template<typename T>
std::set<std::vector<T>> Combinatorics::arrangements_without_repetitions(std::set<T> &s, int k) {
    std::multiset<T> ms(s.begin(), s.end());
